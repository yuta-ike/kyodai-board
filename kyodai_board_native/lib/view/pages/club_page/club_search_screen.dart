...
import 'package:kyodai_board/view/pages/enums/club_filter_type.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildMultiChoiceChips<ClubFilterType>(
                  context,
                  items: ClubFilterType.values,
                  getLabel: (item) => item.asClubType.format,
                  isSelected: (clubFilterType) => query.clubTypes.contains(clubFilterType.asClubType),
                  onSelected: (selected, item){
                    if(selected){
                      query.clubTypes.add(item.asClubType);
                    }else{
                      query.clubTypes = query.clubTypes.where((_item) => _item != item.asClubType).toList();
                    }
                    update();
                  }
                ),
